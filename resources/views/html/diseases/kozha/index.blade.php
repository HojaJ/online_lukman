                        ...
                        <div class="header-breadcrumbs-group">
                            <div class="breadcrumbs">
                                <a href="{{ route('diseases') }}" class="breadcrumbs__previous">Kesel</a> — <span
                                        class="breadcrumbs__current">Deri</span>
                            </div>


                            <h1 class="page-header page-header--name"> Deri </h1>
                            <p class="page-header-description">Deriniň we subkutan dokumanyň zeperlenmegi bilen
                    ...
                    <div class="category box">
                        <div class="no-box-content">
                            ...
                            <ul class="no-cols-list diseases-list">
                                <li><a class="animated-hover" href="kontaktniy-dermatit.html">Kontakt dermatit</a></li>
                                <li><a class="animated-hover" href="piodermiya">Pýoderma</a></li>
                                <li><a class="animated-hover" href="psoriaz">Psoriaz</a></li>
                                <li><a class="animated-hover" href="seboreyniy-dermatit">Seborriki dermatit</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
