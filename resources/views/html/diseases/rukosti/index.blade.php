                        ...
                        <div class="header-breadcrumbs-group">
                            <div class="breadcrumbs">
                                <a href="{{ route('diseases') }}" class="breadcrumbs__previous">Заболевания</a> — <span
                                        class="breadcrumbs__current">Кости, суставы и мышцы</span>
                            </div>


                            <h1 class="page-header page-header--name"> Кости, суставы и мышцы </h1>
                            <p class="page-header-description">Болезни костно-мышечной системы и соединительной
                                ткани.</p></div>
                    </div>
                    ...
                    <div class="category box">
                        <div class="no-box-content">
                            ...
                            <ul class="no-cols-list diseases-list">
                                <li><a class="animated-hover" href="mialgiya-posle-fizicheskikh-nagruzok.html">Миалгия
                                        после физических нагрузок</a></li>
                                <li><a class="animated-hover" href="osteoartroz.html">Остеоартроз</a></li>
                                <li><a class="animated-hover" href="osteoporoz.html">Остеопороз</a></li>
                                <li><a class="animated-hover" href="podagra">Подагра</a></li>
                                <li><a class="animated-hover" href="revmatoidnyj-artrit">Ревматоидный артрит</a></li>
                                <li><a class="animated-hover" href="sistemnaya-krasnaya-volchanka">Системная красная
                                        волчанка</a></li>
                            </ul>
                        </div>
                    </div>
